            ...
            <div className="country-main">
                ...
                <div className="country-info">
                  ...
                  <div className="country-info">
                          ...
                          {borders.map( border => <Link className="country-border" key={border.cca3} to={`/country/${border.cca3}` }>
                          
                          <div className="country-border-flag" style={{backgroundImage: `url(${border?.flags?.svg}`}}>
